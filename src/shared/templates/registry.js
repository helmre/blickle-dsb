...
export const DESIGNER_TEMPLATES = [
  ...
  {
    id: 'designer-dkms-hero',
    name: 'DKMS / Stammzellspende',
    description: 'Emotionale Info-Slide mit Bild, Kernaussage, Meta-Karten und DKMS-Handlungshinweis.',
    category: 'mitarbeiter',
    renderer: 'component',
    editorComponent: 'DkmsHeroEditor',
  ...
  {
    id: 'designer-academy-guest',
    name: 'Academy Gast',
    description: 'Editoriale Academy-Anzeige mit großem Foto, Terminbox und drei Impulskarten.',
    category: 'schulung',
    renderer: 'component',
    editorComponent: 'AcademyGuestEditor',
  ...
  },
  {
    ...
    description: 'Heller PSA-Hinweis mit Pflichtausrüstung, Gültigkeit und prominentem Handlungshinweis.',
    category: 'sicherheit',
    renderer: 'component',
    editorComponent: 'SafetyPsaEditor',
    ...
    requiredFields: [
      ...
      { key: 'ackLabel', label: 'Handlungshinweis' },
    ],
    defaultParams: {
      kicker: 'SICHERHEIT',
      badge: 'WARNUNG',
      headline: 'PSA-Pflicht in der Produktion',
      body: 'In allen Produktionsbereichen gilt: Schutzbrille, Sicherheitsschuhe und Gehörschutz sind Pflicht. Bitte achten Sie auf Ihre eigene Sicherheit und auf die Ihrer Kolleginnen und Kollegen. Bei Fragen wenden Sie sich an Ihre Führungskraft.',
      validFrom: '',
      readingTime: 'ca. 15 Sek.',
      ackLabel: 'Bitte Sicherheitsvorschriften beachten',
      footerNote: 'Aushang gültig bis zur Aktualisierung',
      backgroundImage: '/content/karriere/blickle-produktion.jpg',
      source: 'Arbeitssicherheit Blickle',
      equipment1: 'Schutzbrille',
      equipment2: 'Sicherheitsschuhe',
      equipment3: 'Gehörschutz',
    }
  },
  {
