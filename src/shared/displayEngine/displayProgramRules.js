...
export const PROGRAM_ENTRY_CATALOG = Object.freeze([
  ...
  { type: PROGRAM_ENTRY_TYPES.SYSTEM_PAGE, targetId: 'produktion', label: 'Produktion', description: 'Produktionsnews, Poster und Video' },
  ...
  return [
    {
      ...
      entries: [
        ...
        { id: 'program-entry-produktion', type: PROGRAM_ENTRY_TYPES.SYSTEM_PAGE, targetId: 'produktion', duration: 20, transition: 'fade', enabled: true },
